...
action_23 (39#) = happyShift action_32
...
action_24 x = happyTcHack x happyReduce_33

action_25 (61#) = happyShift action_27
action_25 (26#) = happyGoto action_26
action_25 x = happyTcHack x happyReduce_50

action_26 (36#) = happyShift action_42
action_26 (44#) = happyShift action_43
...
action_26 (25#) = happyGoto action_41
...
action_30 x = happyTcHack x happyReduce_34
...
action_34 x = happyTcHack x happyReduce_33
...
action_38 x = happyTcHack x happyReduce_31

action_39 x = happyTcHack x happyReduce_32

action_40 x = happyTcHack x happyReduce_29

action_41 (31#) = happyShift action_59
action_41 (34#) = happyShift action_60
action_41 (15#) = happyGoto action_56
action_41 (16#) = happyGoto action_57
action_41 (17#) = happyGoto action_58
action_41 x = happyTcHack x happyReduce_19
...
action_57 (17#) = happyGoto action_70
action_57 x = happyTcHack x happyReduce_20

action_58 x = happyTcHack x happyReduce_21

action_59 (37#) = happyShift action_67
action_59 (38#) = happyShift action_68
action_59 (48#) = happyShift action_69
...
action_61 (24#) = happyGoto action_63
action_61 x = happyTcHack x happyFail

action_62 (46#) = happyShift action_73
action_62 x = happyTcHack x happyReduce_30

action_63 (47#) = happyShift action_72
action_63 x = happyTcHack x happyReduce_35

action_64 x = happyTcHack x happyReduce_37

action_65 x = happyTcHack x happyReduce_24

action_66 x = happyTcHack x happyReduce_23

action_67 x = happyTcHack x happyReduce_26

action_68 x = happyTcHack x happyReduce_27

action_69 x = happyTcHack x happyReduce_25

action_70 x = happyTcHack x happyReduce_22

action_71 x = happyTcHack x happyReduce_18

action_72 (35#) = happyShift action_75
action_72 x = happyTcHack x happyFail

action_73 (35#) = happyShift action_64
action_73 (24#) = happyGoto action_74
action_73 x = happyTcHack x happyFail

action_74 (47#) = happyShift action_72
action_74 x = happyTcHack x happyReduce_36

action_75 x = happyTcHack x happyReduce_38
...
happyReduction_25 (HappyTerminal (Tk _ (TString happy_var_1)))
	 =  HappyAbsSyn18
...
happyReduction_26 (HappyTerminal (Tk _ (TInt happy_var_1)))
	 =  HappyAbsSyn18
...
happyReduction_27 (HappyTerminal (Tk _ (TFloat happy_var_1)))
	 =  HappyAbsSyn18
...
happyReduction_30 ((HappyAbsSyn23  happy_var_4) `HappyStk`
	_ `HappyStk`
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	Tk _ TImport -> cont 27#;
	Tk _ TDoc -> cont 28#;
	Tk _ TIface -> cont 29#;
	Tk _ TImplements -> cont 30#;
	Tk _ TDefault -> cont 31#;
	Tk _ TIndex -> cont 32#;
	Tk _ TUnique -> cont 33#;
	Tk _ TCheck -> cont 34#;
	Tk _ (TLowerId happy_dollar_dollar) -> cont 35#;
	Tk _ (TUpperId happy_dollar_dollar) -> cont 36#;
	Tk _ (TInt happy_dollar_dollar) -> cont 37#;
	Tk _ (TFloat happy_dollar_dollar) -> cont 38#;
	Tk _ TSemicolon -> cont 39#;
	Tk _ TLBrace -> cont 40#;
	Tk _ TRBrace -> cont 41#;
	Tk _ TLParen -> cont 42#;
	Tk _ TRParen -> cont 43#;
	Tk _ TLBrack -> cont 44#;
	Tk _ TRBrack -> cont 45#;
	Tk _ TComma -> cont 46#;
	Tk _ TDot -> cont 47#;
	Tk _ (TString happy_dollar_dollar) -> cont 48#;
	Tk _ TWord32 -> cont 49#;
	Tk _ TWord64 -> cont 50#;
	Tk _ TInt32 -> cont 51#;
	Tk _ TInt64 -> cont 52#;
	Tk _ TText -> cont 53#;
	Tk _ TBool -> cont 54#;
	Tk _ TDouble -> cont 55#;
	Tk _ TTime -> cont 56#;
	Tk _ TDate -> cont 57#;
	Tk _ TDateTime -> cont 58#;
	Tk _ TZonedTime -> cont 59#;
	Tk _ TZonedDateTime -> cont 60#;
	Tk _ TMaybe -> cont 61#;
	Tk _ TAsc -> cont 62#;
	Tk _ TDesc -> cont 63#;
	_ -> happyError' (tk:tks)
